...
function devluxe_script_enqueue() {
    ...
    wp_enqueue_style('milligram', get_template_directory_uri() . '/css/milligram.min.css');
...
*/
	...
	function devluxe_custom_post_type (){
...
add_action('init','devluxe_custom_post_type');


function devluxe_custom_taxonomies() {
...
add_action( 'init' , 'devluxe_custom_taxonomies' );
...
/*
	...
	==========================================
*/
function devluxe_get_terms( $postID, $term ){
